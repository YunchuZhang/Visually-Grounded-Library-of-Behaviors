...
def write(voxel_model, fp):
    ...
    fp.write(b'#binvox 1\n')
    dim_str = 'dim '+' '.join(list(map(str, voxel_model.dims)))+'\n'
    dim_bytes = dim_str.encode('utf-8')
    fp.write(dim_bytes)
    translate_str = 'translate '+' '.join(list(map(str, voxel_model.translate)))+'\n'
    translate_bytes = translate_str.encode('utf-8')
    fp.write(translate_bytes)
    scale_str = 'scale '+str(voxel_model.scale)+'\n'
    scale_bytes = scale_str.encode('utf-8') 
    fp.write(scale_bytes)
    fp.write(b'data\n')
