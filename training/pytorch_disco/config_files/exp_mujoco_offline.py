...
exps['train_viewpred_occ_0629'] = ['mujoco_offline',  # mode
                              #'mujoco_offline_data',  # input format
...
exps['train_viewpred_occ_0715_c6_r3'] = ['mujoco_offline',  # mode
                              #'mujoco_offline_data',  # input format
...
exps['train_viewpred_occ_push_0723'] = ['mujoco_offline',  # mode
                              #'mujoco_offline_data',  # input format
                              'push_v7_0722_data',
                              #'load_train_viewpred_occ2',
                              '40k_iters', # num_iters
...
exps['test_train_viewpred_occ2'] = ['mujoco_offline',  # mode
                              #'mujoco_offline_data',  # input format
                              'grasptop_all_data',
                              'load_train_viewpred_occ2',
                              '40k_iters', # num_iters
...
exps['train_rgb_occ_det_as2'] = ['mujoco_offline',
                             'grasptop_all_0707_data', # using full data
                             '500k_iters',
                             'lr3',
                             'B2',
                             'train_feat',  # training featnet
                             'train_occ',   # training occnet
                             'train_view',  # training view
                             'train_det_anchor_size_2',   # training detector
                             'slow_logging']
...
groups['train_det_anchor_size_2'] = ['do_det = True',
                                     'do_deeper_det = True',
                                     'det_anchor_size = 2']
...
groups['push_v7_0722_data'] = ['dataset_name = "mujoco_offline"',
                                 'H = %d' % H,
                                 'W = %d' % W,
                                 'trainset = "train_v7_0722"',
                                 'valset = "test_v7_0722"',
                                 'testset = "test_v7_0722"',
                                 'dataset_list_dir = "/projects/katefgroup/quantized_policies/data_jy/push"',
                                 'dataset_format = "txt"'
]

groups['grasptop_all_0707_data'] = ['dataset_name = "mujoco_offline"',
                                    'H = %d' % H,
                                    'W = %d' % W,
                                    'trainset = "detector_data_full_train"',
                                    'valset = "detector_data_full_val"',
                                    'testset = "detector_data_full_val"',
                                    'dataset_list_dir = "/projects/katefgroup/quantized_policies/data_detector"',
                                    'dataset_format = "txt"'
                                ]
